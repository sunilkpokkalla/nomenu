  ...
  return (
    <>
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none z-20 select-none hidden sm:block">
        ...
        <div className="absolute top-[6%] right-[4%] md:right-[10%] bg-white/90 backdrop-blur-md border border-slate-200/60 shadow-xl rounded-2xl px-4 py-3 flex items-center gap-3 animate-float-fast opacity-0 shadow-amber-500/5" style={{ animationDelay: '3s' }}>
