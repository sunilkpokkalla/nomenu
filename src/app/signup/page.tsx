          ...
          <div className="space-y-6">
            ...
            <form action={loginWithGoogle}>
              <div className="relative group">
                <span className="absolute -top-3 right-4 z-10 bg-indigo-600 text-white text-[10px] font-black uppercase tracking-wider px-2.5 py-0.5 rounded-full shadow-sm">
                  Recommended (Fastest)
                </span>
                <Button type="submit" variant="outline" className="w-full h-14 bg-white hover:bg-slate-50 border-indigo-600 text-slate-800 font-bold flex items-center justify-center gap-3 text-sm rounded-xl shadow-md transition-all hover:shadow-lg">
