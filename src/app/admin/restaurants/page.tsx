...
import { Store, MapPin, Phone, Mail, Ban, ArrowUpCircle } from "lucide-react";
...
export default async function AdminRestaurantsPage(
  ...
  return (
    <div className="space-y-8 font-sans-vibrant">
      <div>
        <h1 className="text-3xl font-extrabold tracking-tight text-slate-900">Restaurant Directory</h1>
        <p className="mt-1 text-slate-500 font-medium">Manage all tenants, impersonate accounts, and control access.</p>
      </div>
