        ...
        <div className="w-full max-w-[480px] bg-white rounded-xl shadow-[0_20px_60px_-15px_rgba(0,0,0,0.1)] p-8 sm:p-12 z-10">
          ...
          <div className="space-y-3 mb-6">
            <form action={loginWithGoogle}>
              <Button type="submit" variant="outline" className="w-full h-12 bg-white hover:bg-slate-50 border-slate-200 text-slate-700 font-medium flex items-center justify-center gap-3 text-base shadow-sm">
