    ...
    return (
      <div className="bg-white border border-slate-200 rounded-2xl p-10 text-center shadow-sm max-w-2xl mx-auto mt-12 w-full">
        ...
        <p className="text-slate-600 mb-8 leading-relaxed">
          Advanced analytics, real-time scan tracking, and detailed visitor insights are available starting on the Pro plan. Upgrade to unlock business intelligence.
        </p>
        <Link 
