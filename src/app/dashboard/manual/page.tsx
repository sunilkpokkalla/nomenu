  ...
  return (
    <div className="p-6 w-full max-w-[1600px] mx-auto space-y-8 animate-in fade-in duration-500">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <Link 
          href="/dashboard/manual/billing"
          className="group bg-white p-8 rounded-3xl shadow-sm border border-slate-200 hover:shadow-lg hover:border-indigo-200 transition-all duration-300 flex flex-col justify-between"
        >
          <div>
            <div className="w-14 h-14 rounded-2xl flex items-center justify-center mb-6 bg-green-100 text-green-600 group-hover:scale-110 transition-transform duration-300">
              <LineChart className="w-7 h-7" />
            </div>
            <h2 className="text-2xl font-bold text-slate-900 mb-3">Billing & Plans</h2>
            <p className="text-slate-500 leading-relaxed">
              Compare subscription tiers (Free, Pro, Elite, Enterprise) and learn how to manage your billing.
            </p>
          </div>
          <div className="mt-8 flex items-center text-indigo-600 font-bold group-hover:translate-x-2 transition-transform duration-300">
            Read Documentation <ArrowRight className="ml-2 w-5 h-5" />
